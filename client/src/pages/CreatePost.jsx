...
const CreatePost = () => {
  ...
  const [generatingImg, setGereatingImg] = useState(false);
  const [loading, setLoading] = useState(false);

  const generateImage = async () => {
    if(form.prompt) {
      try{
          setGereatingImg(true);
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#222328] text-[32px]'>
          ...
          <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
            ...
            generated by DALL-E AI and share them with the community</p>
      </div>
      ...
      <div className='flex flex-col gap-5'>
        ...
        <FormField
          ...
          type='text'
          name='prompt'
          placeholder='A hamburger in the shape of a Rubik’s cube,
        ...
        focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
          {form.photo ? (
            ...
            <img
              src={preview}
              alt='preview'
              className='w-9/12 h-9/12 obkect-contain opacity-40'
            />
          )}
          {generatingImg && (
